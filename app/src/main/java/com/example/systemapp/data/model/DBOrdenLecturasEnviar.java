...
public class DBOrdenLecturasEnviar {
    ...
    public DBOrdenLecturasEnviar(String campoFoto, String id, String tipo, String finilec, String ffinlec, Integer lectact, String critica, Integer causal, Integer observ, String observg, String latitud, String longitud, Integer consumo, String suscriptor, String usuario, String texobser, String texcausa) {
