...
public class LoginUser {
    ...
    public LoginUser(String id, String usuario, String nombre, String tipodeusuario, String email, String empresa,
                          String remenber_token, String estado, String created_at) {
        this.id = id;
